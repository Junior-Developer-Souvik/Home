...
@section('page-title', 'Gallery list')
@section('section')
                    ...
                    <div class="card-header">
                        <div class="row mb-3">
                            <div class="col-md-12 text-right">
                                <a href="{{ route('admin.gallery.create') }}" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Create</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                @forelse ($data as $index => $item)
                                    <tr class="text-left align-middle">
                                        ...
                                        <td class="d-flex text-right">
                                            <div class="btn-group">
                                                <a href="{{ route('admin.gallery.edit', $item->id) }}" class="btn btn-sm btn-dark" data-toggle="tooltip" title="Edit">
        ...
        $('.delete-btn').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'gallery/delete/' + itemId; // Replace '/delete/' with your actual delete route
                }
            });
        });
    });
