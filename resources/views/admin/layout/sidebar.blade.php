    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.collection.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.unit.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.subject.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.job_category.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.user.application.list') }}"
        ...
        <li class="nav-item {{ (request()->is('admin/master-module*')) ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.class.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.facility.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.curricular.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.teaching.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.choose_us.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.event.list.all') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.faculty.list.all') }}"
                ...
                @if(in_array('Gallery', $RolePass))
                    <li class="nav-item">
                        <a href="{{ route('admin.gallery.list.all') }}"
        ...
        <li class="nav-item {{ (request()->is('admin/content*')) ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
                ...
                @if(in_array('Leads', $RolePass))
                    <li class="nav-item">
                        <a href="{{route('admin.lead.list.all')}}"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.schedulecontent.view') }}"
        ...
        <li class="nav-item {{ (request()->is('admin/seo*')) ? 'menu-open' : '' }}">
            <a href="{{route('admin.seo.list.all')}}"
