...
@section('page-title', 'Edit Schedule Content')
                    ...
                    <div class="card-header">
                        <div class="row mb-3">
                            <div class="col-md-12 text-right">
                                <a href="{{ route('admin.schedulecontent.list.all') }}" class="btn btn-sm btn-primary"> <i class="fa fa-chevron-left"></i> Back</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.schedulecontent.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
