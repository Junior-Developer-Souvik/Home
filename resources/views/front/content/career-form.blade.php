                            ...
                            <div class="tab-content">
                                <div class="tab-pannel" id="step1">
                                    <div class="form-box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter your father's name" name="father_name" id="father_name">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        placeholder="Enter your DOB" name="date_of_birth" id="date_of_birth" pattern="\d{2}-\d{2}-\d{4}">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="form-label">Contact No. (M) <span
                                                        class="required">*</span></label>
                                                <div class="form-group phone-input-group">
                                                    ...
                                                    <!--     <button class="btn btn-theme btn-cta">OTP Send</button> -->
                                                    <!--</div>-->
                                                ...
                                                <div class="form-group phone-input-group">
                                                    <div class="phone-number-col email-id-col">
                                                        ...
                                                        <input type="email" class="form-control"
                                                            placeholder="Enter valid email address" name="email" id="email">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Expected Salary (P.A.) <span
                                                            class="required">*</span></label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter your expected salary" name="expected_salasry" id="expected_salasry">
                                                    <p id="error_expected_salasry" class="text-danger err-msg"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                ...
                                <div class="tab-pannel" id="step6">
                                    <div class="form-box">
                                        ...
                                        <div class="row upload-row">
                                            <div class="col-lg-6 col-12 left-col">
                                                <h4>10th Admin Card: <span class="required">*</span></h4>
                                                <p>Note: Only .jpg, .jpeg, .png file formats supported. File size must
                                                    be less than 70 kb.</p>
...
<script>
    $(function(){
        ...
        var year = currentDate.getFullYear()-10;    //substract the year  by ten to get a more recent result, you can change this number for your needs.
        ...
        $('#date_of_birth').attr('max',format);      // By max attribute , we can limit the range of date that user get can't choose the out of range dob
   ...
   $(document).ready(function() {
    ...
    function validateOTP() {
        ...
        if (allFilled) {
            ...
            var enteredOTP = otpValues.join('');
                ...
                if (enteredOTP === storedOTPArray) {
                    localStorage.setItem('verified_email', 1);
    ...
    // Attach keyup event handler to each OTP input field
    ...
    $(document).ready(function() {
        $("#email").keyup(function() {
            ...
            if (!emailRegex.test(email)) {
                ...
                $('#Email_Send_OTP').prop('disabled', true); // Disable the button
            } else {
                $('#Email_Send_OTP').prop('disabled', false); // Enable the button
            }
        });
    });
    ...
    $(document).ready(function() {
        $("#Email_Send_OTP").click(function(event) {
            ...
            if (email.length == "") {
                ...
                $.ajax({
                    url: "{{route('front.career.register.email.verification')}}",
                    type: "GET",
                    ...
                    success: function(response) {
                        if (response.status == 200) {
                            ...
                            $('#Email_Send_OTP').html('Send OTP');
                            $('#otp_message').html('<span style="color: red;">' + response.message + '</span>');
                            // Handle status 500 (Internal Server Error)
                        }
    ...
    $(document).ready(function() {
        $("#first_next").click(function(event) {
            ...
            var merital_status = $("input[name='merital_status']:checked").val();
            ...
            if (name.length == "") {
                ...
                if (verifiedEmail == 1) {
                    ...
                    localStorage.setItem('marital_status',merital_status);
    ...
    $(document).ready(function(){
        $("#second_next").click(function(event) {
            ...
            // } 
                ...
                $("#error_pincode").text("Please enter a valid 6-digit pincode");
                $("#pincode").focus();
                return false;
                ...
                $("#error_state").text("Please choose your state");
                $("#state").focus();
                return false;
    ...
    $(document).ready(function(){
        $("#fourth_next").click(function(event) {
            ...
            return false;
                ...
                $("#error_expected_salasry").text("Please enter your expected salary");
                $("#expected_salasry").focus();
                return false;
            }
            ...
            // Referrence details validation if applicable
                ...
                // Proceed with form submission or navigation to the next step
                var verifiedEmail = localStorage.getItem('verified_email');
                if (verifiedEmail == 1) {
                    console.log('next-form');
        ...
        $("#final_submit").click(function(event) {
            ...
            for (var i = 0; i < requiredFields.length; i++) {
                ...
                if (!checkFileType(fieldInfo.field, fieldInfo.allowedTypes)) {
                    var alertDiv = $('<div class="alert alert-danger alert-dismissible fade show" role="alert">Invalid file type for ' + fieldInfo.name + '. Please upload a valid file type.</div>');
                    $('#final_alert_container').append(alertDiv);
                    setTimeout(function() {
                        alertDiv.alert('close'); // Close the alert after 3 seconds
                        checkNextFile(); // Check the next file after closing the alert
   ...
   // Retrieve data from localStorage
    ...
    var setExpectedSalary = localStorage.getItem('expected_salasry');
    ...
    if (setExpectedSalary) {
        $('#expected_salasry').val(setExpectedSalary);
    }
    if (setJoinTime) {
    ...
    // Fifth Next
    var set_applied_post = localStorage.getItem('applied_post');
    var set_unit_name = localStorage.getItem('unit_name');
    var set_subject = localStorage.getItem('subject');
    if (set_applied_post) {
        $('#applied_post').val(set_applied_post);
    }
    if (set_unit_name) {
        $('#unit_name').val(set_unit_name);
    }
    if (set_subject) {
        $('#subject').val(set_subject);
    }
