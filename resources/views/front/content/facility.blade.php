  ...
  <div class="container">
      <div class="row">
          <div class="col-md-7 pr-lg-5">
              <h2 class="text_blue mb-3">{{$data[0]->title}}</h2>
              <p>{{Str::limit($data[0]->desc, 400)}}</p>
              <img src="{{$data[0]->image}}" class="img-fluid" alt="">
              <div class="facility_qa mt-4">
               
                  <div class="accordion" id="accordionExample">
                      @if(count($data[0]->SubFacilityData))
                        @foreach ($data[0]->SubFacilityData as $key=>$item)
          ...
          <div class="col-md-5 pl-lg-5 mt-lg-0 mt-md-0 mt-5">
              ...
              <div class="media cs_box">
                <img src="{{asset($item->logo)}}" class="align-self-end mr-3" alt="...">
